  ...
  return (
    <div className="footer">
          ...
          <div>
            ...
            <div className="social">
              <Link href="https://www.facebook.com/?locale=ar_AR">
                <FacebookIcon
                  sx={{ color: "blue", marginLeft: "10px", fontSize: "40px" }}
                />
              </Link>
              ...
              <Link href="https://twitter.com/?lang=ar">
                <TwitterIcon
                  sx={{ color: "black", marginLeft: "10px", fontSize: "40px" }}
                />
              </Link>
            </div>
          </div>
      ...
      <h3 className="final-content">
        Copyright © 2023 Onix Digital Co., Ltd. All Rights Reserved. <br />{" "}
        Designed by <em>Mostafa-ELsayed</em>
